 ...
 * 
 */
public class List4Emp121 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		StringBuilder sb = new StringBuilder(
				"SELECT * FROM Empl_pehist WHERE idno IN(");
		while (it.hasNext()) {
		...
		out
				.println("<td align='center' style='mso-number-format:\\@' nowrap>工作機構</td>");
		out
				.println("<td align='center' style='mso-number-format:\\@' nowrap>開始日期</td>");
		out
				.println("<td align='center' style='mso-number-format:\\@' nowrap>終止日期</td>");
		...
		for (int i = 0; i < list.size(); i++) {
			...
			out
					.println("<td align='center' style='mso-number-format:\\@' nowrap>"
							+ ((Map) list.get(i)).get("inst") + "</td>");
			out
					.println("<td align='center' style='mso-number-format:\\@' nowrap>"
							+ ((Map) list.get(i)).get("begin") + "</td>");
			out
					.println("<td align='center' style='mso-number-format:\\@' nowrap>"
							+ ((Map) list.get(i)).get("end") + "</td>");
