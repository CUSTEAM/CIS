...
public class AbilityExamineLanguageAction extends BaseLookupDispatchAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		setContentPage(request.getSession(false),
				"assistant/AbilityExamineLanguage.jsp");
	...
	public ActionForward search(ActionMapping mapping, ActionForm form,
		...
		setContentPage(session, "assistant/AbilityExamineLanguage.jsp");
		return mapping.findForward("Main");
	}
	...
	public ActionForward create(ActionMapping mapping, ActionForm form,
		...
		String classInCharge = getUserCredential(session)
				.getClassInChargeSqlFilterC();
		DynaActionForm aForm = (DynaActionForm) form;
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form,
		...
		for(StdAbility sa : sas){
			if(sa.getAbilityNo()!=3){                    // && sa.getAbilityNo()!=4){    //當勾選刪除項目編號不等於3 or 4 or 5時,語言中心沒有權限刪除
	...
	public ActionForward modify(ActionMapping mapping, ActionForm form,
		...
		ActionMessages messages = new ActionMessages();
		if(sa.getAbilityNo()!=3){                   // && sa.getAbilityNo()!=4){     //當勾選刪除項目編號不等於3 or 4 or 5時,語言中心沒有權限修改
	...
	@SuppressWarnings("unchecked")
	private List<StdAbility> getSelectedStdAbilityByIndex(
			HttpServletRequest request) {
		HttpSession session = request.getSession(false);
		String index = Toolket.getSelectedIndexFromCookie(request,
				ABILITY_EXAMINE_COOKIE_NAME);
		List<StdAbility> data = (List<StdAbility>) session
				.getAttribute(ABILITY_EXAMINE_RESULT_NAME);
		List<StdAbility> sas = new LinkedList<StdAbility>();
