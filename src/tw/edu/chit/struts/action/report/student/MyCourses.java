...
public class MyCourses extends BaseAction{
	/**
	 * 以星期節次查詢可加選課程
	 */
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		list.addAll(manager.ezGetBy("SELECT Select_Limit, (SELECT COUNT(*)FROM Seld WHERE Dtime_oid=d.Oid) as seled, " +
				...
				"Dtime_class dc, Csno c, Class cl WHERE d.Sterm='"+request.getParameter("term")+"' AND cl.ClassNo=d.depart_class AND " +
				"c.cscode=d.cscode AND e.idno=d.techid AND d.Oid=dc.Dtime_oid AND " +
