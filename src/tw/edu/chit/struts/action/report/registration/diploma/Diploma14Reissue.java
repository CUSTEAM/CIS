...
public class Diploma14Reissue extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		out.println ("    <o:LastPrinted>2010-01-18T06:27:00Z</o:LastPrinted>");
		out.println ("    <o:Created>2010-02-03T02:31:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-02-03T02:31:00Z</o:LastSaved>");
		out.println ("    <o:Pages>1</o:Pages>");
		out.println ("    <o:Words>35</o:Words>");
		out.println ("    <o:Characters>200</o:Characters>");
		out.println ("    <o:Company>中華科技大學</o:Company>");
		out.println ("    <o:Lines>1</o:Lines>");
		out.println ("    <o:Paragraphs>1</o:Paragraphs>");
		out.println ("    <o:CharactersWithSpaces>234</o:CharactersWithSpaces>");
		...
		out.println ("      <w:basedOn w:val='a'/>");
		out.println ("      <w:rsid w:val='00FC5856'/>");
		out.println ("      <w:rPr>");
		...
		out.println ("      <w:rsid w:val='00453B64'/>");
		out.println ("      <w:pPr>");
		out.println ("        <w:tabs>");
		...
		out.println ("        <w:p wsp:rsidR='00466E9C' wsp:rsidRDefault='00466E9C' wsp:rsidP='00453B64'>");
		out.println ("          <w:r>");
		...
		out.println ("      <wsp:rsid wsp:val='001F63D3'/>");
		out.println ("      <wsp:rsid wsp:val='00215D4E'/>");
		out.println ("      <wsp:rsid wsp:val='003D48DE'/>");
		out.println ("      <wsp:rsid wsp:val='00453B64'/>");
		out.println ("      <wsp:rsid wsp:val='00466E9C'/>");
		out.println ("      <wsp:rsid wsp:val='00494FE8'/>");
		out.println ("      <wsp:rsid wsp:val='007350E2'/>");
		out.println ("      <wsp:rsid wsp:val='007B5C8C'/>");
		out.println ("      <wsp:rsid wsp:val='008A1003'/>");
		out.println ("      <wsp:rsid wsp:val='008B4BC5'/>");
		out.println ("      <wsp:rsid wsp:val='00931F70'/>");
		out.println ("      <wsp:rsid wsp:val='00A11777'/>");
		out.println ("      <wsp:rsid wsp:val='00B33925'/>");
		out.println ("      <wsp:rsid wsp:val='00B43DBD'/>");
		out.println ("      <wsp:rsid wsp:val='00BB32D6'/>");
		out.println ("      <wsp:rsid wsp:val='00C62549'/>");
		out.println ("      <wsp:rsid wsp:val='00C759D4'/>");
		out.println ("      <wsp:rsid wsp:val='00D33ED3'/>");
		out.println ("      <wsp:rsid wsp:val='00DB24E1'/>");
		out.println ("      <wsp:rsid wsp:val='00E56979'/>");
		out.println ("      <wsp:rsid wsp:val='00FC5856'/>");
		out.println ("    </wsp:rsids>");
		out.println ("  </w:docPr>");
		...
		for(int i=0; i<students.size(); i++){
			...
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRDefault='003D48DE' wsp:rsidP='00DB24E1'>");
			out.println ("      <w:pPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00A11777'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='007350E2'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRDefault='003D48DE' wsp:rsidP='00453B64'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00453B64'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t>（</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00453B64' wsp:rsidRPr='00453B64'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='001F63D3'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <st1:chmetcnv TCSC='0' NumberType='1' Negative='False' HasSpace='False' SourceValue='903' UnitName='a' w:st='on'>");
			out.println ("        <w:r wsp:rsidR='008A1003'>");
			out.println ("          <w:rPr>");
			out.println ("            <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("            <wx:font wx:val='標楷體'/>");
			out.println ("            <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRPr='008A1003' wsp:rsidRDefault='003D48DE' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='008A1003'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00453B64'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='1760' w:id='-1138062080'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRPr='008A1003' wsp:rsidRDefault='00453B64' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00BB32D6' wsp:rsidRPr='008A1003' wsp:rsidRDefault='003D48DE' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00B43DBD'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='11'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='8284' w:id='-1138061564'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00BB32D6' wsp:rsidRPr='008A1003'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='008B4BC5' wsp:rsidRPr='008A1003' wsp:rsidRDefault='008B4BC5' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00931F70' wsp:rsidRPr='008A1003'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRDefault='003D48DE' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48' w:first-line-chars='200' w:first-line='1040'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:spacing w:val='60'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00B43DBD' wsp:rsidRDefault='00B43DBD' wsp:rsidP='00B43DBD'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003D48DE' wsp:rsidRPr='00BB32D6' wsp:rsidRDefault='003D48DE' wsp:rsidP='00453B64'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='600' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:jc w:val='center'/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='000175CC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00BD33DC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println("          <v:shape id='_x0000_s1026' type='#_x0000_t202' style='position:absolute;top:-22;left:-1;text-align:left;margin-left:66pt;margin-top:58.85pt;width:280pt;height:35.5pt;z-index:1;mso-width-relative:margin;mso-height-relative:margin' stroked='f'>");
			...
			out.println ("    <w:sectPr wsp:rsidR='003D48DE'>");
