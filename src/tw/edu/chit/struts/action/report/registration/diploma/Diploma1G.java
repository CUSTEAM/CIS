...
public class Diploma1G extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		Date date=new Date();
		response.setHeader("Content-disposition","attachment;filename=Diploma1G"+date.getTime()+".doc");
		...
		out.println ("    <o:Title>中華科技大學碩士學位證書</o:Title>");
		...
		out.println ("    <o:LastPrinted>2010-01-18T05:19:00Z</o:LastPrinted>");
		out.println ("    <o:Created>2010-05-23T12:15:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-05-23T12:15:00Z</o:LastSaved>");
		...
		out.println ("      <w:rsid w:val='003B4150'/>");
		out.println ("      <w:pPr>");
		...
		out.println ("      <wsp:rsid wsp:val='00005E78'/>");
		out.println ("      <wsp:rsid wsp:val='00090F3D'/>");
		out.println ("      <wsp:rsid wsp:val='000C12EC'/>");
		out.println ("      <wsp:rsid wsp:val='000C77D1'/>");
		out.println ("      <wsp:rsid wsp:val='00275256'/>");
		out.println ("      <wsp:rsid wsp:val='002B2D81'/>");
		out.println ("      <wsp:rsid wsp:val='003B4150'/>");
		out.println ("      <wsp:rsid wsp:val='003B7EB9'/>");
		out.println ("      <wsp:rsid wsp:val='00427A44'/>");
		out.println ("      <wsp:rsid wsp:val='005E2EB8'/>");
		out.println ("      <wsp:rsid wsp:val='006174E6'/>");
		out.println ("      <wsp:rsid wsp:val='00C35148'/>");
		out.println ("      <wsp:rsid wsp:val='00CD28C6'/>");
		out.println ("      <wsp:rsid wsp:val='00E41B13'/>");
		out.println ("      <wsp:rsid wsp:val='00EC6FF9'/>");
		out.println ("      <wsp:rsid wsp:val='00EF0965'/>");
		out.println ("      <wsp:rsid wsp:val='00F4204C'/>");
		out.println ("      <wsp:rsid wsp:val='00FA132A'/>");
		out.println ("    </wsp:rsids>");
		out.println ("  </w:docPr>");
		out.println ("  <w:body>");
		...
		for(int i=0; i<students.size(); i++){
			...
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRDefault='003B4150' wsp:rsidP='003B4150'>");
			out.println ("      <w:pPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRPr='00117E7D' wsp:rsidRDefault='003B4150' wsp:rsidP='003B4150'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:jc w:val='center'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='003B4150'>");
			...
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='20'/>");
			out.println ("          <w:fitText w:val='600' w:id='-510438912'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("          <w:sz w:val='20'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>大碩字第</w:t>");
			out.println ("      </w:r>");
			out.println ("      <st1:chmetcnv UnitName='g' SourceValue='961' HasSpace='False' Negative='False' NumberType='1' TCSC='0' w:st='on'>");
			out.println ("        <w:r wsp:rsidRPr='00117E7D'>");
			out.println ("          <w:rPr>");
			out.println ("            <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("            <wx:font wx:val='標楷體'/>");
			out.println ("            <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRPr='003B7EB9' wsp:rsidRDefault='003B4150' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='484' w:hanging-chars='100' w:hanging='436'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='005E2EB8'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='880' w:id='-510438911'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='1760' w:id='-510438910'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("      <w:r>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='細明體' w:fareast='細明體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			//out.println ("        <w:t>電子工程研究所</w:t>");
			try{
				if(aStudent.get("showDeptName").toString().length()<=10){
					out.println ("        <w:t>"+aStudent.get("showDeptName")+"　　　碩士班</w:t>");	
				}else{
					out.println ("        <w:t>"+aStudent.get("showDeptName")+"碩士班</w:t>");	
				}
			}catch(Exception e){
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='000C12EC' wsp:rsidRPr='000C12EC' wsp:rsidRDefault='003B4150' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='000C12EC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='7895' w:id='-441793024'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>修業期滿成績及格准予畢業依學位授予</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRPr='000C12EC' wsp:rsidRDefault='003B4150' wsp:rsidP='000C12EC'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='464' w:id='-441793023'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>法</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='000C12EC' wsp:rsidRPr='000C12EC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:w w:val='95'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='4840' w:id='-441792768'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>之規定授予"+aStudent.get("title")+"碩士學</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='000C12EC' wsp:rsidRPr='000C12EC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRDefault='003B4150' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00005E78' wsp:rsidRDefault='00005E78' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='005E2EB8' wsp:rsidRDefault='005E2EB8' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='003B4150' wsp:rsidRPr='00117E7D' wsp:rsidRDefault='003B4150' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00EF0965' wsp:rsidRPr='003B4150' wsp:rsidRDefault='00EF0965' wsp:rsidP='005E2EB8'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println("          <v:shape id='_x0000_s1026' type='#_x0000_t202' style='position:absolute;top:-62;left:-1;text-align:left;margin-left:66pt;margin-top:58.85pt;width:280pt;height:35.5pt;z-index:1;mso-width-relative:margin;mso-height-relative:margin' stroked='f'>");
			...
			out.println ("    <w:sectPr wsp:rsidR='00EF0965' wsp:rsidRPr='003B4150' wsp:rsidSect='00005E78'>");
