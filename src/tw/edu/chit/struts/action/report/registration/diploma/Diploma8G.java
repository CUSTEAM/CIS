...
public class Diploma8G extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		Date date=new Date();
		response.setHeader("Content-disposition","attachment;filename=Diploma8G"+date.getTime()+".doc");
		...
		out.println ("    <o:LastPrinted>2010-01-18T06:16:00Z</o:LastPrinted>");
		out.println ("    <o:Created>2010-01-29T19:35:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-01-29T19:36:00Z</o:LastSaved>");
		out.println ("    <o:Pages>1</o:Pages>");
		out.println ("    <o:Words>30</o:Words>");
		out.println ("    <o:Characters>176</o:Characters>");
		out.println ("    <o:Company>CHIT</o:Company>");
		out.println ("    <o:Lines>1</o:Lines>");
		out.println ("    <o:Paragraphs>1</o:Paragraphs>");
		out.println ("    <o:CharactersWithSpaces>205</o:CharactersWithSpaces>");
		...
		out.println ("      <w:basedOn w:val='a'/>");
		out.println ("      <w:rsid w:val='00EC54EC'/>");
		out.println ("      <w:rPr>");
		...
		out.println ("      <w:rsid w:val='00571CC6'/>");
		out.println ("      <w:pPr>");
		out.println ("        <w:tabs>");
		...
		out.println ("        <w:p wsp:rsidR='00491C7A' wsp:rsidRDefault='00491C7A' wsp:rsidP='00571CC6'>");
		out.println ("          <w:r>");
		...
		out.println ("      <wsp:rsidRoot wsp:val='006174E6'/>");
		out.println ("      <wsp:rsid wsp:val='00006AE2'/>");
		out.println ("      <wsp:rsid wsp:val='00033131'/>");
		out.println ("      <wsp:rsid wsp:val='00055BFA'/>");
		out.println ("      <wsp:rsid wsp:val='00104B49'/>");
		out.println ("      <wsp:rsid wsp:val='00113BED'/>");
		out.println ("      <wsp:rsid wsp:val='001A462C'/>");
		out.println ("      <wsp:rsid wsp:val='00293709'/>");
		out.println ("      <wsp:rsid wsp:val='002979B7'/>");
		out.println ("      <wsp:rsid wsp:val='002A001D'/>");
		out.println ("      <wsp:rsid wsp:val='002A0E82'/>");
		out.println ("      <wsp:rsid wsp:val='00332958'/>");
		out.println ("      <wsp:rsid wsp:val='004411AA'/>");
		out.println ("      <wsp:rsid wsp:val='00491C7A'/>");
		out.println ("      <wsp:rsid wsp:val='00571CC6'/>");
		out.println ("      <wsp:rsid wsp:val='005E3225'/>");
		out.println ("      <wsp:rsid wsp:val='006174E6'/>");
		out.println ("      <wsp:rsid wsp:val='00681EE4'/>");
		out.println ("      <wsp:rsid wsp:val='006F4EF5'/>");
		out.println ("      <wsp:rsid wsp:val='00763344'/>");
		out.println ("      <wsp:rsid wsp:val='00782288'/>");
		out.println ("      <wsp:rsid wsp:val='007C1222'/>");
		out.println ("      <wsp:rsid wsp:val='00853378'/>");
		out.println ("      <wsp:rsid wsp:val='008F3957'/>");
		out.println ("      <wsp:rsid wsp:val='00A0517F'/>");
		out.println ("      <wsp:rsid wsp:val='00A1694C'/>");
		out.println ("      <wsp:rsid wsp:val='00A935D2'/>");
		out.println ("      <wsp:rsid wsp:val='00AA3A52'/>");
		out.println ("      <wsp:rsid wsp:val='00C66895'/>");
		out.println ("      <wsp:rsid wsp:val='00DF45EB'/>");
		out.println ("      <wsp:rsid wsp:val='00E7520D'/>");
		out.println ("      <wsp:rsid wsp:val='00E94185'/>");
		out.println ("      <wsp:rsid wsp:val='00EC54EC'/>");
		out.println ("      <wsp:rsid wsp:val='00EE2C1A'/>");
		out.println ("      <wsp:rsid wsp:val='00EE30A5'/>");
		out.println ("      <wsp:rsid wsp:val='00EF0965'/>");
		out.println ("      <wsp:rsid wsp:val='00F4204C'/>");
		out.println ("      <wsp:rsid wsp:val='00F63AFB'/>");
		out.println ("      <wsp:rsid wsp:val='00F65D48'/>");
		out.println ("      <wsp:rsid wsp:val='00FB2EDE'/>");
		out.println ("    </wsp:rsids>");
		out.println ("  </w:docPr>");
		out.println ("  <w:body>");
		...
		for(int i=0; i<students.size(); i++){
			...
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRDefault='004411AA' wsp:rsidP='004411AA'>");
			out.println ("      <w:pPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRPr='00117E7D' wsp:rsidRDefault='004411AA' wsp:rsidP='004411AA'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:jc w:val='center'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("          <w:sz w:val='56'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>中華科技大學碩士學位證書</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRDefault='004411AA' wsp:rsidP='00571CC6'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00EE30A5'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='20'/>");
			out.println ("          <w:fitText w:val='600' w:id='-510445056'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>（</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00571CC6' wsp:rsidRPr='00EE30A5'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='20'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>華科大碩字第</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00571CC6'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='008F3957'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRDefault='004411AA' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='004411AA'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='003B7EB9'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>日生　在本</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00EE30A5'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>"+aStudent.get("deptName")+"</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRPr='004411AA' wsp:rsidRDefault='004411AA' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>晶片設計產業研發碩士專班修業期滿成績及格准予畢業依學位授予法</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='004411AA' wsp:rsidRPr='004411AA' wsp:rsidRDefault='004411AA' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>碩士</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00C66895'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00293709' wsp:rsidRPr='00EC54EC' wsp:rsidRDefault='00293709' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00EC54EC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00293709' wsp:rsidRDefault='00293709' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00033131' wsp:rsidRDefault='00033131' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00293709' wsp:rsidRPr='00293709' wsp:rsidRDefault='00293709' wsp:rsidP='00571CC6'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:jc w:val='center'/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00293709'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00E94185' wsp:rsidRPr='00293709' wsp:rsidRDefault='00E94185' wsp:rsidP='00C66895'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println("          <v:shape id='_x0000_s1026' type='#_x0000_t202' style='position:absolute;top:-108;left:-1;text-align:left;margin-left:66pt;margin-top:58.85pt;width:280pt;height:35.5pt;z-index:1;mso-width-relative:margin;mso-height-relative:margin' stroked='f'>");
			...
			out.println("      </w:r>");
			out.println("    </w:p>");
			out.println ("    <w:sectPr wsp:rsidR='00E94185' wsp:rsidRPr='00293709' wsp:rsidSect='00293709'>");
