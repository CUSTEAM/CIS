...
public class Diploma72 extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		Date date=new Date();
		response.setHeader("Content-disposition","attachment;filename=Diploma72"+date.getTime()+".doc");
		...
		out.println ("    <o:Title>中華科技大學附設進修學院學士學位證書</o:Title>");
		...
		out.println ("    <o:Created>2010-05-22T01:54:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-05-22T01:54:00Z</o:LastSaved>");
		...
		out.println ("      <wsp:rsid wsp:val='0093045A'/>");
		out.println ("      <wsp:rsid wsp:val='009530B6'/>");
		out.println ("      <wsp:rsid wsp:val='00962AC5'/>");
		out.println ("      <wsp:rsid wsp:val='00963474'/>");
		out.println ("      <wsp:rsid wsp:val='00AC0F84'/>");
		out.println ("      <wsp:rsid wsp:val='00BA3C1B'/>");
		out.println ("      <wsp:rsid wsp:val='00BB4596'/>");
		...
		out.println ("      <wsp:rsid wsp:val='00FE16A0'/>");
		out.println ("      <wsp:rsid wsp:val='00FF1FB8'/>");
		out.println ("    </wsp:rsids>");
		out.println ("  </w:docPr>");
		out.println ("  <w:body>");
		...
		for(int i=0; i<students.size(); i++){
			...
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRDefault='009530B6'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        <w:gridCol w:w='4723'/>");
			out.println ("        <w:gridCol w:w='3775'/>");
			out.println ("      </w:tblGrid>");
			out.println ("      <w:tr wsp:rsidR='009530B6' wsp:rsidTr='00532E59'>");
			out.println ("        <w:trPr>");
			...
			out.println ("          </w:tcPr>");
			out.println ("          <w:p wsp:rsidR='009530B6' wsp:rsidRDefault='009530B6' wsp:rsidP='00C978B8'>");
			out.println ("            <w:pPr>");
			out.println ("              <w:jc w:val='center'/>");
			out.println ("              <w:rPr>");
			...
			out.println ("              </w:rPr>");
			out.println ("              <w:t>中華科技大學附設進修學院</w:t>");
			out.println ("            </w:r>");
			out.println ("            <w:r>");
			out.println ("              <w:rPr>");
			out.println ("                <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("            <w:r wsp:rsidR='00962AC5'>");
			out.println ("              <w:rPr>");
			out.println ("                <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("                <wx:font wx:val='標楷體'/>");
			out.println ("                <w:sz w:val='22'/>");
			...
			out.println ("      </w:tr>");
			out.println ("    </w:tbl>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRPr='00084A1D' wsp:rsidRDefault='009530B6' wsp:rsidP='00394E9E'>");
			out.println ("      <w:pPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00A57E39'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRPr='00084A1D' wsp:rsidRDefault='00962AC5' wsp:rsidP='00DA33B3'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='009530B6'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='009530B6' wsp:rsidRPr='00084A1D'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRPr='00084A1D' wsp:rsidRDefault='009530B6' wsp:rsidP='00DA33B3'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='0093045A'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00962AC5'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00962AC5' wsp:rsidRPr='00962AC5'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRDefault='009530B6' wsp:rsidP='00DA33B3'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRPr='00D771DB' wsp:rsidRDefault='009530B6' wsp:rsidP='003E3C75'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='009530B6' wsp:rsidRDefault='009530B6' wsp:rsidP='00963474'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("    <w:sectPr wsp:rsidR='009530B6' wsp:rsidSect='00963474'>");
