...
public class Diploma64Reissue extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		Date date=new Date();
		response.setHeader("Content-disposition","attachment;filename=Diploma64Reissue"+date.getTime()+".doc");		
		...
		out.println ("    <o:TotalTime>3</o:TotalTime>");
		out.println ("    <o:LastPrinted>2006-08-28T05:59:00Z</o:LastPrinted>");
		out.println ("    <o:Created>2010-01-29T18:42:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-01-29T18:42:00Z</o:LastSaved>");
		out.println ("    <o:Pages>1</o:Pages>");
		out.println ("    <o:Words>37</o:Words>");
		out.println ("    <o:Characters>217</o:Characters>");
		out.println ("    <o:Company>CHIT</o:Company>");
		out.println ("    <o:Lines>1</o:Lines>");
		out.println ("    <o:Paragraphs>1</o:Paragraphs>");
		out.println ("    <o:CharactersWithSpaces>253</o:CharactersWithSpaces>");
		...
		out.println ("    </w:font>");
		out.println ("    <w:font w:name='細明體'>");
		out.println ("      <w:altName w:val='MingLiU'/>");
		out.println ("      <w:panose-1 w:val='02020509000000000000'/>");
		out.println ("      <w:charset w:val='88'/>");
		out.println ("      <w:family w:val='Modern'/>");
		...
		out.println ("      <w:rsid w:val='00171A19'/>");
		out.println ("      <w:pPr>");
		out.println ("        <w:tabs>");
		...
		out.println ("  </w:styles>");
		out.println ("  <w:divs>");
		out.println ("    <w:div w:id='907425189'>");
		...
		out.println ("        <w:p wsp:rsidR='00EE750C' wsp:rsidRDefault='00EE750C' wsp:rsidP='00171A19'>");
		out.println ("          <w:r>");
		...
		out.println ("      <wsp:rsidRoot wsp:val='00DF7EF5'/>");
		out.println ("      <wsp:rsid wsp:val='00041D62'/>");
		out.println ("      <wsp:rsid wsp:val='00171A19'/>");
		out.println ("      <wsp:rsid wsp:val='00180DD3'/>");
		out.println ("      <wsp:rsid wsp:val='001B6D83'/>");
		out.println ("      <wsp:rsid wsp:val='001C070D'/>");
		out.println ("      <wsp:rsid wsp:val='0023452B'/>");
		out.println ("      <wsp:rsid wsp:val='002763DB'/>");
		out.println ("      <wsp:rsid wsp:val='0029007D'/>");
		out.println ("      <wsp:rsid wsp:val='003E105C'/>");
		out.println ("      <wsp:rsid wsp:val='00494C81'/>");
		out.println ("      <wsp:rsid wsp:val='00542D0E'/>");
		out.println ("      <wsp:rsid wsp:val='005B1590'/>");
		out.println ("      <wsp:rsid wsp:val='005C0F42'/>");
		out.println ("      <wsp:rsid wsp:val='006A51A0'/>");
		out.println ("      <wsp:rsid wsp:val='006B4F06'/>");
		out.println ("      <wsp:rsid wsp:val='00700E19'/>");
		out.println ("      <wsp:rsid wsp:val='00964CA6'/>");
		out.println ("      <wsp:rsid wsp:val='00B30BEE'/>");
		out.println ("      <wsp:rsid wsp:val='00B866B0'/>");
		out.println ("      <wsp:rsid wsp:val='00DE7386'/>");
		out.println ("      <wsp:rsid wsp:val='00DF7EF5'/>");
		out.println ("      <wsp:rsid wsp:val='00EE604F'/>");
		out.println ("      <wsp:rsid wsp:val='00EE750C'/>");
		out.println ("    </wsp:rsids>");
		out.println ("  </w:docPr>");
		out.println ("  <w:body>");		
		...
		for(int i=0; i<students.size(); i++){
			...
			//}
			sy=manager.getSchoolYear().toString();
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00B30BEE' wsp:rsidRDefault='00B30BEE' wsp:rsidP='00DE7386'>");
			out.println ("      <w:pPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRDefault='001B6D83'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00700E19' wsp:rsidRDefault='001B6D83' wsp:rsidP='00700E19'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='180' w:line-rule='at-least'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:jc w:val='center'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00041D62'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='60'/>");
			out.println ("          <w:sz-cs w:val='60'/>");
			out.println ("          <w:fitText w:val='6956' w:id='-1461483520'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>中華</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='003E105C' wsp:rsidRPr='00041D62'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00B866B0' wsp:rsidRPr='00041D62'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00700E19' wsp:rsidRDefault='001B6D83' wsp:rsidP='00171A19'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='001C070D'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:w w:val='90'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='22'/>");
			out.println ("          <w:sz-cs w:val='22'/>");
			...
			out.println ("        <w:t>（</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00180DD3' wsp:rsidRPr='001C070D'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t>）</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00700E19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00180DD3'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00700E19' wsp:rsidRDefault='001B6D83' wsp:rsidP='00171A19'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='200' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='110' w:hanging-chars='50' w:hanging='110'/>");
			out.println ("        <w:jc w:val='right'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00700E19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00542D0E' wsp:rsidRDefault='001B6D83' wsp:rsidP='006B4F06'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00542D0E'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>學生"+aStudent.get("student_name")+" </w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00171A19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='細明體' w:fareast='細明體' w:h-ansi='細明體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='細明體'/>");
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='54'/>");
			out.println ("          <w:sz w:val='40'/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00171A19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='5'/>");
			out.println ("          <w:w w:val='99'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='1760' w:id='-1138061312'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>中</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00171A19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00DF7EF5' wsp:rsidRPr='00542D0E'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>年制</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00542D0E' wsp:rsidRDefault='00171A19' wsp:rsidP='006B4F06'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='500' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00542D0E' wsp:rsidRDefault='001B6D83' wsp:rsidP='006B4F06'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='500' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='8340' w:id='-1138060798'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>修業期滿成績及格准予畢業依學位授予</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00171A19'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00B866B0' wsp:rsidRPr='00542D0E' wsp:rsidRDefault='001B6D83' wsp:rsidP='006B4F06'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='500' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='0029007D' wsp:rsidRPr='00542D0E'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00B866B0' wsp:rsidRPr='00542D0E'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>據該生申明前領學士學位證書遺失經查屬實 特予證明</w:t>");
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00B866B0' wsp:rsidRPr='00542D0E' wsp:rsidRDefault='00B866B0' wsp:rsidP='006B4F06'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='500' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00B866B0' wsp:rsidRDefault='001B6D83' wsp:rsidP='00B866B0'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='500' w:line-rule='exact'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00B866B0'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:spacing w:val='60'/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00B866B0' wsp:rsidRDefault='001B6D83'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00DE7386' wsp:rsidRDefault='001B6D83' wsp:rsidP='00171A19'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:jc w:val='center'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00DE7386'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00964CA6' wsp:rsidRPr='00DE7386'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00700E19' wsp:rsidRDefault='001B6D83'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			...
			out.println("          <v:shape id='_x0000_s1026' type='#_x0000_t202' style='position:absolute;top:37;left:-1;text-align:left;margin-left:66pt;margin-top:58.85pt;width:280pt;height:35.5pt;z-index:1;mso-width-relative:margin;mso-height-relative:margin' stroked='f'>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:sectPr wsp:rsidR='001B6D83'>");
