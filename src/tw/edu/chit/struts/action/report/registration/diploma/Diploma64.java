...
public class Diploma64 extends BaseAction{
...
public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception {	
		...
		Date date=new Date();
		response.setHeader("Content-disposition","attachment;filename=Diploma64"+date.getTime()+".doc");
		...
		out.println ("    <o:LastPrinted>2010-05-21T02:40:00Z</o:LastPrinted>");
		out.println ("    <o:Created>2010-05-23T13:26:00Z</o:Created>");
		out.println ("    <o:LastSaved>2010-05-23T13:26:00Z</o:LastSaved>");
		out.println ("    <o:Pages>1</o:Pages>");
		out.println ("    <o:Words>35</o:Words>");
		out.println ("    <o:Characters>202</o:Characters>");
		out.println ("    <o:Company>CHIT</o:Company>");
		out.println ("    <o:Lines>1</o:Lines>");
		out.println ("    <o:Paragraphs>1</o:Paragraphs>");
		out.println ("    <o:CharactersWithSpaces>236</o:CharactersWithSpaces>");
		...
		out.println ("      <w:basedOn w:val='a'/>");
		out.println ("      <w:rsid w:val='00301B58'/>");
		out.println ("      <w:rPr>");
		...
		out.println ("      <wsp:rsid wsp:val='00005392'/>");
		out.println ("      <wsp:rsid wsp:val='000175CC'/>");
		out.println ("      <wsp:rsid wsp:val='001B6D83'/>");
		out.println ("      <wsp:rsid wsp:val='001E3A0A'/>");
		out.println ("      <wsp:rsid wsp:val='0023452B'/>");
		out.println ("      <wsp:rsid wsp:val='00301B58'/>");
		out.println ("      <wsp:rsid wsp:val='0035613B'/>");
		out.println ("      <wsp:rsid wsp:val='003B30AC'/>");
		out.println ("      <wsp:rsid wsp:val='004654EA'/>");
		out.println ("      <wsp:rsid wsp:val='00517B06'/>");
		out.println ("      <wsp:rsid wsp:val='00517E0A'/>");
		out.println ("      <wsp:rsid wsp:val='006A51A0'/>");
		out.println ("      <wsp:rsid wsp:val='00700E19'/>");
		out.println ("      <wsp:rsid wsp:val='008C6201'/>");
		out.println ("      <wsp:rsid wsp:val='009F6127'/>");
		out.println ("      <wsp:rsid wsp:val='00AB4EB3'/>");
		out.println ("      <wsp:rsid wsp:val='00B02074'/>");
		out.println ("      <wsp:rsid wsp:val='00B83530'/>");
		out.println ("      <wsp:rsid wsp:val='00BA54E2'/>");
		out.println ("      <wsp:rsid wsp:val='00C54D9B'/>");
		out.println ("      <wsp:rsid wsp:val='00CF35EA'/>");
		...
		for(int i=0; i<students.size(); i++){
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00AB4EB3'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00AB4EB3' wsp:rsidRPr='00AB4EB3'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='15'/>");
			out.println ("          <w:w w:val='96'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='60'/>");
			out.println ("          <w:sz-cs w:val='60'/>");
			...
			out.println ("        <w:t></w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='004654EA'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("        <w:t>（</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00B83530' wsp:rsidRPr='004654EA'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00B83530'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='22'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>字</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='004654EA'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00005392'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00BA54E2'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00C54D9B' wsp:rsidRDefault='001B6D83' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='001E3A0A'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='880' w:id='-1138060032'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>學生</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00DF7EF5' wsp:rsidRPr='00C54D9B'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidRPr='00C54D9B'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='1760' w:id='-1138060287'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='009F6127' wsp:rsidRPr='00C54D9B'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>月"+aStudent.get("birth_day")+"</w:t>");
			out.println ("      </w:r>");		
			out.println ("        <w:r wsp:rsidRPr='00C54D9B'>");
			out.println ("          <w:rPr>");
			out.println ("            <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			...
			out.println ("            <w:sz-cs w:val='44'/>");
			out.println ("          </w:rPr>");
			out.println ("          <w:t>生在本校四年制</w:t>");
			out.println ("        </w:r>");
			out.println ("      </w:p>");		
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='00C54D9B' wsp:rsidRDefault='00DF7EF5' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='001B6D83' wsp:rsidRPr='00C54D9B'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='00301B58' wsp:rsidRPr='00301B58' wsp:rsidRDefault='001B6D83' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left-chars='20' w:left='48'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='23'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='00301B58'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			out.println ("          <w:b-cs/>");
			out.println ("          <w:spacing w:val='24'/>");
			out.println ("          <w:kern w:val='0'/>");
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='8269' w:id='-441800960'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("          <w:sz w:val='44'/>");
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("          <w:fitText w:val='450' w:id='-441800959'/>");
			out.println ("        </w:rPr>");
			...
			out.println ("      </w:r>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='009F6127' wsp:rsidRDefault='001B6D83' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20' w:first-line-chars='200' w:first-line='1120'/>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:spacing w:val='60'/>");
			...
			out.println ("        </w:rPr>");
			out.println ("      </w:pPr>");
			out.println ("      <w:r wsp:rsidRPr='009F6127'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:spacing w:val='60'/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='000175CC' wsp:rsidRDefault='000175CC' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001E3A0A' wsp:rsidRPr='009F6127' wsp:rsidRDefault='001E3A0A' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRPr='000175CC' wsp:rsidRDefault='001B6D83' wsp:rsidP='00517B06'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:jc w:val='center'/>");
			...
			out.println ("          <w:sz-cs w:val='44'/>");
			out.println ("        </w:rPr>");
			out.println ("        <w:t>中華民國"+aStudent.get("year")+"</w:t>");
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='003B30AC' wsp:rsidRPr='000175CC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:r>");
			out.println ("      <w:r wsp:rsidR='00DF7EF5' wsp:rsidRPr='000175CC'>");
			out.println ("        <w:rPr>");
			out.println ("          <w:rFonts w:ascii='標楷體' w:fareast='標楷體' w:h-ansi='標楷體' w:hint='fareast'/>");
			out.println ("          <wx:font wx:val='標楷體'/>");
			out.println ("          <w:b/>");
			...
			out.println ("      </w:pPr>");
			out.println ("    </w:p>");
			out.println ("    <w:p wsp:rsidR='001B6D83' wsp:rsidRDefault='001B6D83' wsp:rsidP='001E3A0A'>");
			out.println ("      <w:pPr>");
			out.println ("        <w:spacing w:line='640' w:line-rule='exact'/>");
			out.println ("        <w:ind w:left='20'/>");
			out.println ("        <w:rPr>");
			...
			out.println("          <v:shape id='_x0000_s1026' type='#_x0000_t202' style='position:absolute;top:-46;left:-1;text-align:left;margin-left:66pt;margin-top:58.85pt;width:280.65pt;height:35.5pt;z-index:1;mso-width-relative:margin;mso-height-relative:margin' stroked='f'>");
