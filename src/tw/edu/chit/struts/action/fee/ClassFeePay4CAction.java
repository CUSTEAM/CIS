...
public class ClassFeePay4CAction extends BaseLookupDispatchAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		setContentPage(session, "fee/ClassFeePay4CInfo.jsp");
	...
	public ActionForward classFeePayList(ActionMapping mapping,
		...
		session.setAttribute(FEE_KIND_1, feeKind1);
		session.setAttribute(FEE_KIND_2, Collections.EMPTY_LIST);
		if (feeKind1.isEmpty()) {
			ActionMessages messages = new ActionMessages();
			messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
					"Course.errorN1", "查無任何學雜費資料,可自行新增班級學雜費,謝謝"));
	...
	public ActionForward chooseAdd(ActionMapping mapping, ActionForm form,
		...
		setContentPage(request.getSession(false), "fee/ClassFeePay4CAdd.jsp");
		return mapping.findForward(IConstants.ACTION_MAIN_NAME);
	}
	...
	public ActionForward chooseUpdate(ActionMapping mapping, ActionForm form,
		...
		setContentPage(session, "fee/ClassFeePay4CUpdate.jsp");
		return mapping.findForward(IConstants.ACTION_MAIN_NAME);
	}
	...
	public ActionForward courseFee4C(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		setContentPage(session, "fee/ClassFeePay4ClassAdd.jsp");
		return mapping.findForward(IConstants.ACTION_MAIN_NAME);
	}

	public ActionForward courseFee4CAdd(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	protected Map<String, String> getKeyMethodMap() {
		...
		map.put("fee.add.courseFee4C", "courseFee4C");
		map.put("fee.add.courseFee4CAdd", "courseFee4CAdd");
