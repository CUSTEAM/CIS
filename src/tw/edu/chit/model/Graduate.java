...
/**
 * Gstmd generated by MyEclipse - Hibernate Tools
 */

public class Graduate extends StudentBase implements java.io.Serializable {

	private static final long serialVersionUID = 1619040492338158123L;
	...
	private String schlCode; // 畢業學校名稱(命名相反為歷史包袱) //John:去你媽的多搞一個文字欄位很爽嗎
	private String schlName; // 畢業學校代碼(命名相反為歷史包袱)
	private String gradDept; // 畢業科系
	...
	public Graduate(String departClass, String studentNo, String studentName) {
	...
	public Graduate(String departClass, String studentNo, String studentName,
			...
			String schlCode, String graduStatus, String parentName,
			String telephone, String permPost, String permAddr,
			String occurStatus, Short occurYear, String occurTerm,
			Date occurDate, String occurDocno, String occurCause,
			String occurGraduateNo, String identBasic, String extraStatus,
			String extraDept, String email, String cellPhone,
			String identRemark, Short gradyearOrigin, String studentEname) {
		this.departClass = departClass;
		this.studentNo = studentNo;
		this.studentName = studentName;
		this.sex = sex;
