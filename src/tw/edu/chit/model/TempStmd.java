...
/**
 * TempStmd generated by MyEclipse Persistence Tools
 */

public class TempStmd implements java.io.Serializable {
	...
	private Integer registrationCardOid;

	private Integer imageOid;
	...
	/** minimal constructor */
	public TempStmd(String schoolYear, String studentName) {
		this.schoolYear = schoolYear;
		this.studentName = studentName;
	}

	/** full constructor */
	public TempStmd(String schoolYear, String departClass, String studentNo,
			String studentName, String sex, Date birthday, String idno,
			Short entrance, Short gradyear, String ident, String divi,
			String birthProvince, String birthCounty, String currPost,
			String currAddr, String schlCode, String gradDept,
			String graduStatus, String parentName, String telephone,
			String permPost, String permAddr, String occurStatus,
			Short occurYear, String occurTerm, Date occurDate,
			String occurDocno, String occurCause, String occurGraduateNo,
			String identBasic, String extraStatus, String extraDept,
			String email, String cellPhone, String identRemark,
			Short gradyearOrigin, String studentEname, String schlName,
			Integer registrationCardOid, Integer imageOid, String tempNo,
			String serialNo) {
		this.schoolYear = schoolYear;
		...
		this.registrationCardOid = registrationCardOid;
	...
	public Integer getRegistrationCardOid() {
		return this.registrationCardOid;
	}

	public void setRegistrationCardOid(Integer registrationCardOid) {
		this.registrationCardOid = registrationCardOid;
	}

	public Integer getImageOid() {
		return this.imageOid;
	}

	public void setImageOid(Integer imageOid) {
		this.imageOid = imageOid;
	}
