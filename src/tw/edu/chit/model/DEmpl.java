...
public class DEmpl extends EmplBase implements java.io.Serializable {
	...
	/** minimal constructor */
	public DEmpl(String idno) {
		this.idno = idno;
	}

	/** full constructor */
	public DEmpl(String idno, String cname, String insno, String ename,
