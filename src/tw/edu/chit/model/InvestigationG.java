 ...
 */
public class InvestigationG implements java.io.Serializable {
	...
	public InvestigationG() {
	}

	public InvestigationG(Integer oid) {
		this.oid = oid;
	}

	public InvestigationG(Integer oid, String post, String address,
