		...
		<table width="100%">
			<tr>
				...
				<table class="hairLineTable" width="98%">
					...
					<tr>
						<td class="hairLineTdF" align="right">兼任導師:</td>
						<td class="hairLineTdF">${aEmpl.Tutor}</td>
					</tr>
					<tr>
						<td class="hairLineTdF" align="right">戶地:</td>
						<td class="hairLineTdF">${aEmpl.pzip}${aEmpl.paddr}</td>
					</tr>
					<tr>
						<td class="hairLineTdF" align="right">居地:</td>
					...
					<tr>
						<td class="hairLineTdF" align="right">單位:</td>
			...
			<tr>
				...
				<table>
					...
					<tr>
						...
						<table class="hairLineTable" width="98%">
							<tr>
								<td class="hairLineTd" align="center">帳號</td>
								<td class="hairLineTd" align="center">密碼</td>
							</tr>
							<tr>
								<td class="hairLineTdF" align="center"><input type="text" value="${myAccount.idno}" disabled></td>
								<td class="hairLineTdF" align="center"><input type="text" value="${myAccount.password}" disabled></td>
							</tr>
						</table>
...
<c:if test="${h.saveStartDate!=''&&h.saveEndDate!=''}">
	...
	<tr height="30">
		...
		<INPUT type="submit"
						   ...
						   value="<bean:message key='EditDemplConfirm'/>"
