...
<html:form action="/Score/JustToHistory" method="post" onsubmit="init('處理中, 請稍後')">
	<tr height="30">
		<td class="fullColorTable">		
		<div style="float:left; padding:0 5 0 5;"><img src="images/folder_page.gif"/></div>
		<div nowrap style="float:left;"><font class="gray_15">儲存歷年操行成績</font></div>		
		</td>
	</tr>
	<tr>
		<td>
		...
		<table class="hairLineTable">
			<tr>
				...
				<input type="submit" name="method" class="gSubmit" value="<bean:message key='ToComb1'/>" id="ToComb1"/>
				<input type="submit" name="method" class="gSubmit" value="<bean:message key='ToComb2'/>" id="ToComb2"/>
				</td>
