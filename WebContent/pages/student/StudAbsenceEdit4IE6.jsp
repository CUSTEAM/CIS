...
<!-- End Content Page Table Header -->
	...
	<tr>
        ...
        <td class="hairlineTdF">
            <input type="text" name="startDate" id="startDate" size="10" readonly="readonly" maxlength="8" value="${formback.startDate}" onChange=" changePeriods();">
	...
	<tr>
		...
		<c:set var="ldate" value="${(dArray[0] + 1911)}-${dArray[1]}-${dArray[2]}" />
        <td class="hairlineTdF">
            <input type="text" name="endDate" id="endDate" size="10" readonly="readonly" maxlength="8" value="${formback.endDate}" onChange=" changePeriods();">
	...
	<tr>
		<td class="hairlineTdF">&nbsp;&nbsp;開始日期&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="hairlineTdF">
            <input type="text" name="startDate" id="startDate" size="10" readonly="readonly" maxlength="8" value="" onChange=" changePeriods();">
	...
	<tr>
        ...
        <td class="hairlineTdF">
            <input type="text" name="endDate" id="endDate" size="10" readonly="readonly" maxlength="8" value="" onChange=" changePeriods();">
...
function changePeriods(){
	...
	if(sdate != "" && edate != "" && (sdatea.length==3 && edatea.length==3)){		
		if(sdatea[0]<=edatea[0] || (sdatea[0]==edatea[0] && sdatea[1]<=edatea[1]) ||
			...
			var jsonQuery = '{"method":"getStudentPeriodData", "startDate":"' + startValue + '","endDate":"' + endValue + '","docOid":""}';
...
function deleteFile(objfile) {
   ...
   jQuery.ajax({ url: jsonQuery, type:"GET", dataType:"json", success: function(jsonRep) { delSuccess(jsonRep, objfile.parent()); } });
