...
<html:form action="/Student/PhaseTwoAddDelCourse" method="post" onsubmit="init('處理中,請稍後...');">
	<%--
	...
	<script>
		generateTableBanner('<div class="gray_15"><B> 可 加 選 課 程 資 料 </B></div>');
		<%--generateTableBanner('<div class="gray_15"><font color="red"><B>注意：部份一年級課程有選課人數上限限制 </B></font></div>');--%>
	</script>
	<tr>
		<td>
  	...
  	<script>
  		generateTableBanner('<INPUT type="submit" name="method" class="CourseButton" value="<bean:message key='course.courseSearch.btn.addOpencs' bundle='COU'/>" onclick="return addCourseCheck();">&nbsp;'
