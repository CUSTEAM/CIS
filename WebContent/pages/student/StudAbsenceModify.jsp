...
<!-- End Content Page Table Header -->
	...
	<tr>
        ...
        <td class="hairlineTdF">
            <input type="text" name="startDate" size="10" maxlength="8" readonly="readonly" value="${formback.startDate}" onBlur=" changePeriods();">
	...
	<tr>
        ...
        <td class="hairlineTdF">
            <input type="text" name="endDate" size="10" maxlength="8" readonly="readonly" value="${formback.endDate}" onBlur=" changePeriods();">
    			<img src="<%=basePath%>pages/images/cal.gif" name="calendar" width="20" height="20"
    				align="top" style="cursor:hand" alt="點選此處選擇日期"
	...
	<tr>
		<td class="hairlineTdF">&nbsp;&nbsp;開始日期&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="hairlineTdF">
            <input type="text" name="startDate" size="10" maxlength="8" readonly="readonly" value="${formback.simpleStartDate}" onBlur=" changePeriods();">
    			<img src="<%=basePath%>pages/images/cal.gif" name="calendar" width="20" height="20"
		      		align="top" style="cursor:hand" alt="點選此處選擇日期"
		  	  		onclick="javascript:if(!startDate.disabled)popCalFrame.fPopCalendar('startDate','startDate',event);">&nbsp;
        </td>
	...
	<tr>
        <td class="hairlineTdF">&nbsp;&nbsp;結束時間&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="hairlineTdF">
            <input type="text" name="endDate" size="10" maxlength="8" readonly="readonly" value="${formback.simpleEndDate}" onBlur=" changePeriods();">
    			<img src="<%=basePath%>pages/images/cal.gif" name="calendar" width="20" height="20"
    				align="top" style="cursor:hand" alt="點選此處選擇日期"
 		  	  		onclick="javascript:if(!endDate.disabled)popCalFrame.fPopCalendar('endDate','endDate',event);">
        </td>
