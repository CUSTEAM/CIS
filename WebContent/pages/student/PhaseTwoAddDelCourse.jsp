...
<html:form action="/Student/PhaseTwoAddDelCourse" method="post" onsubmit="init('系統處理中...')">
	<script>generateTableBanner('<div class="gray_15"><B><bean:message key="student.phaseTwoAddDelCourse.banner" bundle="STD"/></B></div>');</script>
		...
		<td>
			...
			<display:table name="${seldDataInfoOpt1}" export="false" id="row" pagesize="10000" sort="list" excludedParams="*" class="list">
		        ...
		        <display:column titleKey="Course.label.courseName" sortable="false" class="left">
		        	${row.csName}&nbsp;
		        	<html:link page="/Student/PhaseTwoAddDelCourse.do?method=readCourseIntro" paramName="row" paramId="oid" paramProperty="dtimeOid" onmouseover="stm(Text[1], Style[1])" onmouseout="htm()">
						[<font color="blue">中英文簡介</font>]
					</html:link>&nbsp;
					<html:link page="/Student/PhaseTwoAddDelCourse.do?method=readCourseSyllabus" paramName="row" paramId="oid" paramProperty="dtimeOid" onmouseover="stm(Text[0], Style[0])" onmouseout="htm()">
