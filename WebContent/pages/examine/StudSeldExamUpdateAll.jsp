...
<form action="/CIS/Examine/StudSeldExamUpdateAll.do" method="post" name="caForm">
...
<!-- End Content Page Table Header -->
	...
	<table cellspacing="5" class="empty-border" width="100%">
		<tr>
			...
			<font color="red" style="size:20px;">執行時間較久，<b style="background-color: #ddAADD;">最佳更新方式請以系所為單位</b>，請耐心等候...</font>
			<br/><br/></td>
		</tr>
	    <tr>
