...
<html:form action="/OpinionSuggestion" method="post" onsubmit="init('Email寄送處理中...')">
<script>generateTableBanner('<div class="gray_15"><B>教 職 員 意 見 反 映</B></div>');</script>
	<tr>
		<td>
       		<table width="100%" cellspacing="5" class="empty-border">
 		 		<tr>
 		 			<td width="80" align="right">教職員姓名：</td>
					<td>
		       			<html:text property="name" size="10" value="${memberInfo.name}" readonly="true" />&nbsp;&nbsp;&nbsp;&nbsp;
	       		 		電子信箱：
		 	   			<html:text property="email" size="40" value="${memberInfo.email}" />&nbsp;
		 	   		</td>
		 	   	</tr>
		 		<tr>
