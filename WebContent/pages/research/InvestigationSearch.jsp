...
<html:form action="/Research/InvestigationSearch" method="post" onsubmit="init('系統處理中...')">
	<script>
	 			...
	 			<tr>
	 				<td align="center">
      					<display:table name="${invesList}" export="false" id="row" pagesize="10" sort="list" excludedParams="*" class="list">
        					...
        					<display:column title="系所名稱" property="deptName" sortable="true" class="center" />
        					<display:column title="班級名稱" property="name" sortable="true" class="center" />
        					<display:column title="出路下載" sortable="false" class="center" href="/CIS/Teacher/Tutor/GraduateInvestigationList.do?t=d" paramId="no" paramProperty="no">
