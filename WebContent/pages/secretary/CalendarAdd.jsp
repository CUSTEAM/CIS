				...
				<tr bgcolor="#f0fcd7">
					<td class="hairlineTdF">&nbsp;&nbsp;事項&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF">
                     	<html:text property="title" styleId="title" size="20" maxlength="80"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                    <td class="hairlineTdF">&nbsp;&nbsp;地點&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF" colspan="3">
                     	<html:text property="location" styleId="location" size="20" maxlength="50"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
				</tr>
				<tr bgcolor="#f0fcd7">
                    ...
                    <td class="hairlineTdF">&nbsp;&nbsp;主持人&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF" colspan="3">
                     	<html:text property="host" styleId="host" size="20" maxlength="20"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
				<tr bgcolor="#f0fcd7">    
				...
				<tr bgcolor="#f0fcd7">
					<td class="hairlineTdF">&nbsp;&nbsp;承辦單位&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF" colspan="5">
                     	<html:textarea property="content" styleId="content" cols="60" rows="5"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
				</tr>
			</table>
    	</td>
