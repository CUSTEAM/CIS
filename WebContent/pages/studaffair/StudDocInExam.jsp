...
<form action="/CIS/StudAffair/StudAbsenceExam.do" method="post" name="inputForm">
<input name="examMode" type="hidden" value="${StudDocExamInit.examMode}"/>
<input name="docOid" type="hidden" value="${StudDocInExam.oid}"/>
<input name="status" id="status" type="hidden" value=""/>

<!-- Begin Content Page Table Header -->
<table width="100%" cellpadding="2" cellspacing="2">
<script>generateTableBanner('請假管理->審核');</script>	  
<!-- End Content Page Table Header -->
	<c:set var="doc" value="${StudDocInExam}" />
	<tr><td><table width="100%" >
		...
		<tr>
			<td width="75" class="title" valign="top">審核說明</td>
