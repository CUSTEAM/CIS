...
<form action="/CIS/StudAffair/ConductMarkCode.do" method="post" name="tfdForm">

<!-- Begin Content Page Table Header -->
<table width="100%" cellpadding="0" cellspacing="0">
<script>generateTableBanner('<bean:message key="SAFTitle.ConductMarkCodeDelete" bundle="SAF"/>');</script>	  
	<tr>
...
<!-- End Content Page Table Header -->
	...
	<c:if test="${ConductMarkCodeDelete != null}" >
	    <tr><td height="10"></td></tr>
		<tr>
		    <td><table width="100%" cellpadding="0" cellspacing="0">
		      <tr><td align="center">  
	      		<display:table name="${ConductMarkCodeDelete}" export="false" id="row" pagesize="100" sort="list" excludedParams="*" class="list">
	  			<c:if test="${empty ConductMarkCodeDelete}">
