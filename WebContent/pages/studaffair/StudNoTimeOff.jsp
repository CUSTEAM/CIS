...
<!--
	...
	function preview(){
		...
		if(isValidate) {
			...
			subwin = window.open("/CIS/StudAffair/StudNoTimeOff.do?method=PrintPreview" + str, "預覽列印",
...
<form action="/CIS/StudAffair/StudNoTimeOff.do" method="post" name="ceForm" onsubmit="init('報表產生中, 請稍後')">
<table width="100%" cellpadding="0" cellspacing="0">

<script>generateTableBanner('<div class="gray_15"><B><bean:message key="SAFTitle.StudNoTimeOff" bundle="SAF"/></B></div>');</script>	  
	<tr>
		<td>
	...
	<table width="100%" cellspacing="5" class="empty-border">
      ...
      <tr>
        ...
        <td  height="30" align="left" valign="middle">
        	<c:set var="campusSel" value="${NTFStudentInit.campus}"/>
	  		<c:set var="schoolSel" value="${NTFStudentInit.school}"/>
	  		<c:set var="deptSel"   value="${NTFStudentInit.dept}"/>
	  		<c:set var="classSel"  value="${NTFStudentInit.departClass}"/>
