...
<form action="/CIS/StudAffair/CantExam.do" method="post" name="ceForm">
...
<!-- End Content Page Table Header -->
	...
	<c:if test="${CantExamList != null}" >
    	...
    	<tr>
    		<td><br>選擇輸出格式:
    			<a href="studaffair/CantExamExport.jsp?type=excel">
    			<img src="images/ico_file_excel.png" border="0"> Excel
    			</a>
    			<a href="studaffair/CantExamExport.jsp?type=word">
