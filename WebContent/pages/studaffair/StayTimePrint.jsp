...
function preview(isPreview) {
	...
	if (isPreview && bFlag) {	
		// alert(str);
		subwin = window.open("/CIS/StudAffair/StayTimePrint.do?method=preview" + str, "預覽列印",
...
<html:form action="/StudAffair/StayTimePrint" method="post" onsubmit="init('報表產生中, 請稍後')">
