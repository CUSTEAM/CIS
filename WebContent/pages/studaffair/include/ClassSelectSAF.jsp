...
// -->
  ...
  <SELECT name="campusInChargeSAF" tabindex="${tcnt}" id="${tcnt}" onchange="fillSchools();">
    ...
    <SELECT name="schoolInChargeSAF" tabindex="${tcnt}" id="${tcnt}" onchange="fillDepts();">
    </SELECT>
    <c:set var="tcnt" value="${tcnt + 1}"/>
    <SELECT name="deptInChargeSAF" tabindex="${tcnt}" id="${tcnt}" onchange="fillClasses();">
    <c:set var="tcnt" value="${tcnt + 1}"/>
    </SELECT><SELECT name="classInChargeSAF" tabindex="${tcnt}" id="${tcnt}" ></SELECT>
    <c:set var="tcnt" value="${tcnt + 1}"/>	   		    
