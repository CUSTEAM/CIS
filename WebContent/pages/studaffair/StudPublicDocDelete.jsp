...
<script>generateTableBanner('公假管理->刪除');</script>	  
<!-- End Content Page Table Header -->
	<c:forEach items="${StudPubDocDelete}" var="doc">
	<tr><td><table width="100%" >
	<tr>
		<td width="100" align="left" class="title">系所</td>
	    <td height="30" class="input" align="left" valign="middle">${doc.deptClassName}</td>
	</tr>
