...
<form action="/CIS/StudAffair/StudConductModify.do" method="post" name="bpForm">
...
<script>generateTableBanner('<div class="gray_15"><B><bean:message key="SAFTitle.StudConductModify" bundle="SAF"/></B></div>');</script>	  
	<tr>
		<td align="left"> 
<!-- End Content Page Table Header -->
	...
	<c:when test="${StudConductModify != null}">
	<c:forEach items="${StudConductModify}" var="Conduct">
        ...
        <tr>
        	...
        	<c:set var="tcnt" value="${tcnt + 1}"/>
        	<td align="center" valign="middle" bgcolor="#99ee90" id="totalScoreInput">${Conduct.totalScore}
        	</td>
			<input type="hidden" name="totalScore" value="${Conduct.totalScore}" id="htotalScore">
        </tr>
        <tr>
        <td colspan="7">
	        <table width=100%">
	...
	<c:when test="${StudConductInEdit != null}">
	<c:forEach items="${StudConductInEdit}" var="Conduct">
		<input name="studentNo" type="hidden" value="${Conduct.studentNo}">
		<tr>
			<td align="left" valign="middle" colspan="7">學號 ：${Conduct.studentNo}
       			&nbsp;&nbsp;${Conduct.studentName}
