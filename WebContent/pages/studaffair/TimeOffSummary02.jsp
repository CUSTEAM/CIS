...
<!--
	...
	function preview(){
		...
		if(isValidate) {
			...
			subwin = window.open("/CIS/StudAffair/TimeOffSummary02.do?method=PrintPreview" + str, "預覽列印",
...
<form action="/CIS/StudAffair/TimeOffSummary02.do" method="post" name="ceForm" onsubmit="init('報表產生中, 請稍後')">
<table width="100%" cellpadding="0" cellspacing="0">

<script>generateTableBanner('<div class="gray_15"><B><bean:message key="SAFTitle.TimeOffSummary2" bundle="SAF"/></B></div>');</script>	  
	<tr>
		<td>
	...
	<table width="100%" cellspacing="5" class="empty-border">
      ...
      <tr>
        ...
        <td  height="30" align="left" valign="middle">
        	<c:set var="campusSel" value="${TFSummaryInit.campus}"/>
	  		<c:set var="schoolSel" value="${TFSummaryInit.school}"/>
	  		<c:set var="deptSel"   value="${TFSummaryInit.dept}"/>
	  		<c:set var="classSel"  value="${TFSummaryInit.departClass}"/>
			<%@ include file="/pages/studaffair/include/ClassSelectSAF.jsp" %>
        </td>
      </tr>
      <tr>
        <td  height="30" width="70" align="left" valign="middle" bgcolor="#d8bfd8">週次：      
      	<td>
      		<input type="text" name="WeekNo" value="" size="2">
      	</td>
      </tr>
      <tr>
        <td  height="30" width="70" align="left" valign="middle" bgcolor="#d8bfd8">列印範圍：      
      	<td>
      		<input type="radio" name="pmode" value="0" checked>全校
      		<input type="radio" name="pmode" value="1">畢業班
      	</td>
      </tr>
	</table>
		</td>		
