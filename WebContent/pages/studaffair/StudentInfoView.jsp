...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
  <html:form action="${OriginAction}" method="post">
	...
	<tr><td>
       <table width="100%" cellspacing="5" class="empty-border">
		 <tr><td><bean:message key="Name"/>&nbsp;
		 	 ...
		 	 <td></td>
		     <td>所屬班級&nbsp;
  			   <input type="text" name="departClass2" size="20" value="${StudentInfoEdit.departClass2}"></td></tr>
 		 <tr><td><bean:message key="Sex"/>&nbsp;
  			 ...
  			 <td><bean:message key="Idno"/>&nbsp;
  			   <input type="text" name="idNo"	size="12" value="個人資料保護"></td></tr>
	...
	<c:if test="${StudentInfoEdit.mode == 'View'}">
	  ...
	  <script>generateTableBanner('<INPUT type="submit" name="method" class="CourseButton" value="<bean:message key='Back'  />">');</script>
	</c:if>  
  </html:form>
  <c:if test="${StudentInfoEdit.mode == 'View'}">
    <script language="javascript">
