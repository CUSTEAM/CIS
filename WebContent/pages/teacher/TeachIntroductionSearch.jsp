...
<html:form action="/Teacher/TeachIntroductionSearch" method="post">
	<script>
		generateTableBanner('<div class="gray_15"><B><bean:message key="teacher.introductionSearch.banner" bundle="TCH"/>- <font color="red" size="+1">${schoolYear}</font>&nbsp;學年度</B></div>');
	</script>
	...
	<tr>
	 				...
	 				<td align="center">
	 					<div id="term1" style="display:inline;">
      					<display:table name="${teacherDtime1}" export="false" id="row" pagesize="10000" sort="list" excludedParams="*" class="list">
        					...
        					<display:column titleKey="Course.label.courseEname" property="engName" sortable="true" class="center" />
   	...
   	<script>
   		generateTableBanner('<INPUT type="submit" name="method" value="<bean:message key='teacher.introductionSearch.btn.search' bundle="TCH" />" onclick="return searchCheck();" class="CourseButton">&nbsp;');
   	</script>
	<!-- /c:if -->
</html:form>
</table>
