...
<form action="/CIS/Teacher/Counseling.do" method="post" name="bpForm">
	...
	<table cellspacing="5" class="empty-border" width="100%">
		<tr>
		    <td><table width="100%" cellpadding="0" cellspacing="0">
		      <tr><td align="center">  
	      		<display:table name="${StudCounselDeleteL}" export="false" id="row" pagesize="100" sort="list" excludedParams="*" class="list">
	  			<c:if test="${empty StudCounselDeleteL}">
