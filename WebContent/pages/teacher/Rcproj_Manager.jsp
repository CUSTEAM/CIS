...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <html:form action="/Teacher/Rcproj_Manager" method="post" enctype="multipart/form-data" onsubmit="init('系統處理中...')">
<!-- 標題列 start -->
    <tr>
      <td class="fullColorTable" width="100%">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr height="30">
            <td align="center" valign="middle"><b>承接政府部門計劃與產學案資料維護&nbsp;</b></td>
          </tr>
        </table>
      </td>
    </tr>	     
        ...
        <table width="99%" class="hairLineTable">
          ...
          <tr>
            <td>                         
              ...
              <table width="99%" class="hairLineTable"> 
                <tr>
                  <td width="15% align="center" class="hairLineTdF"">
                  	摘要/簡述
                  </td>
                  <td colspan="3">
	  ...
	  <tr>
        <td class="hairLineTd" align="center">
          ...
          <input name="Submit04" type="submit" value="匯出Excel" class="CourseButton"
                 onclick="MM_goToURL('parent','/CIS/pages/teacher/Article/RcprojSel.jsp');return document.MM_returnValue"/>
        </td>
      </tr>
    </c:if>    
  </html:form>
