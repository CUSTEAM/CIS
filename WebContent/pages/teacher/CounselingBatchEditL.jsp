...
<input type="hidden" name="students" value="${CounselingLStEcts}"/>
...
<!-- End Content Page Table Header -->
	...
	<c:choose>
	<c:when test="${CounselingBatchEdit4L != null}">
	<c:set var="formback" value="${CounselingBatchEdit4L}"/>
		<tr>
			<td><table width="100%"><tr>
			<td width="80" align="right">學生：</td>
			<td><table>
			<c:set var="cnt" value="0"/>
			<c:forEach items="${CounselingLStuds}" var="stud">
				<c:if test="${cnt==0}">
					<tr>
				</c:if>
