...
<form action="/CIS/Teacher/CounselingModify.do" method="post" name="bpForm">
...
<!-- End Content Page Table Header -->
	...
	<c:choose>
	<c:when test="${StudCounselingModifyL != null}">
	<c:set var="formback" value="${StudCounselingModifyL}"/>
		<tr>
			<td><table width="100%"><tr>
			<td width="80" align="right" class="td_lable_normal">學生：</td>
	        <td  height="30" colspan="4" align="left" valign="middle">
	        	${StudCounselingModifyL.className}&nbsp;&nbsp;${StudCounselingModifyL.studentName}
	        </td>
			<td>&nbsp;</td>
	        </tr></table></td>
        </tr>
        ...
        <tr>
        	...
        	<c:forEach items="${StudCounselCodeL}" var="code">
        		<c:if test="${code.itemNo==StudCounselingModifyL.itemNo}">
        ...
        <tr>
        	...
        	<td align="left" valign="middle">
        	<textarea name="content" rows="3" cols="60">${StudCounselingModifyL.content}</textarea>
        	</td>
			<td>&nbsp;</td>
	        </tr></table></td>
        </tr>
	...
	<c:when test="${StudCounselInEditL != null}">
	<c:set var="formback" value="${StudCounselInEditL}"/>
		<tr>
			<td><table width="100%"><tr>
			<td width="80" align="right" class="td_lable_normal">學生：</td>
	        <td  height="30" colspan="4" align="left" valign="middle">
	        	${StudCounselInEditL.className}&nbsp;&nbsp;${StudCounselInEditL.studentName}
	        </td>
			<td>&nbsp;</td>
	        </tr></table></td>
        </tr>
        ...
        <tr>
			...
			<td width="80" align="right" class="td_lable_normal">輔導日期：</td>
	        <td  width="90">
	            <input type="text" name="cdate" id="cdate" size="10" readonly="readonly" maxlength="10" value="${formback.simpleCdate}">
	        </td>
			<td width="20">	  
	     			<!--<img src="<%=basePath%>pages/images/cal.gif" name="sCalImg" id="sCalImg" width="20" height="20"
			      		align="top" style="cursor:hand" alt="點選此處選擇日期">-->&nbsp;
        ...
        <tr>
        	...
        	<select name="itemNo" id="itemNo">
        	<c:forEach items="${StudCounselCodeL}" var="code">
        		<c:if test="${code.itemNo==StudCounselInEditL.itemNo}">
        		<option value="${code.itemNo}" selected="selected">${code.itemName}</option>
        		</c:if>
        		<c:if test="${code.itemNo!=StudCounselInEditL.itemNo}">
        		<option value="${code.itemNo}">${code.itemName}</option>
        ...
        <tr>
        	...
        	<td width="80" align="right" valign="middle">輔導內容：</td>
        	<td align="left" valign="middle">
        	<textarea name="content" rows="3" cols="60">${StudCounselInEditL.content}</textarea>
        	</td>
			<td>&nbsp;</td>
	        </tr></table></td>
        </tr>
