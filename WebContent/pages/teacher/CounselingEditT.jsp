...
<form action="/CIS/Teacher/Tutor/CounselingEdit.do" method="post" name="bpForm">
...
<!-- End Content Page Table Header -->
	...
	<c:choose>
	<c:when test="${StudCounselingEdit != null}">
	<c:set var="formback" value="${StudCounselingEdit}"/>
		<tr>
			<td><table width="100%"><tr>
			<td width="80" align="right">學生：</td>
	        <td  height="30" colspan="4" align="left" valign="middle" class="hairLineTd">
	        	${StudCounselStudentT.className}&nbsp;&nbsp;${StudCounselStudentT.studentNo} ${StudCounselStudentT.studentName}
	        </td>
			<td>&nbsp;</td>
	        </tr></table></td>
        </tr>
        ...
        <tr>
        	...
        	<td align="left" valign="middle" class="hairLineTd">
        		<select name="ctype" onchange="changeItem(this.value);">
        			<c:if test="${StudCounselingEdit.ctype=='T'}">
        			<option value="T" selected="selected">職涯輔導</option>
         			<option value="U">學習輔導</option>
        			</c:if>
        			<c:if test="${StudCounselingEdit.ctype=='U'}">
        ...
        <tr>
        	...
        	<c:forEach items="${CounselCode}" var="code">
        		<c:if test="${code.itemNo==StudCounselingEdit.itemNo}">
        ...
        <tr>
        	...
        	<td align="left" valign="middle" class="hairLineTd">
        	<textarea name="content" rows="3" cols="60">${StudCounselingEdit.content}</textarea>
        	</td>
 			<td>&nbsp;</td>
        	</tr></table></td>
        </tr>
