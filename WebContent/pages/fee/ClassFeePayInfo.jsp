...
<script>
	generateTableBanner('<table align="left"><tr><td align="left">&nbsp;&nbsp;<img src="images/16-cube-debug.png"></td><td>班 級 代 辦 費 資 料 維 護</td></tr></table>');
</script>
	<tr>
		<td>
			...
			<table align="center">
				<tr>
					<td>
						...
						<html:submit styleId="previewB" property="method" styleClass="CourseButton"><bean:message key="fee.add.courseFee" bundle="FEE"/></html:submit>
					</td>					
				</tr>
			</table>
		</td>
		...
		<td>
			...
			<display:table name="${feePays}" export="false" id="row" pagesize="10" sort="list" excludedParams="*" class="list">
				...
				<display:column title="" sortable="false" class="center">
					<html:link page="/FEE/ClassFee.do?method=classFeePayList" paramName="row" paramId="dc" paramProperty="departClass">
