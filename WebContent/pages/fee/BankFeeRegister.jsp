...
function check() {
	...
	else if (document.getElementsByName("feeType")[2].checked)
		feeType = document.getElementsByName("feeType")[2].value;
...
<html:form action="/FEE/BankFeeRegister" method="post" enctype="multipart/form-data" onsubmit="init('執行中, 請稍後')">
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<script>
	generateTableBanner('<table align="left"><tr><td align="left">&nbsp;&nbsp;<img src="images/16-cube-debug.png"></td><td> 銀 行 繳 費 資 料 更 新 註 冊 檔</td></tr></table>');
</script>
	<tr>
		<td>
			<table class="empty-border">
				...
				<tr>
					<td class="hairlineTdF">&nbsp;&nbsp;銀行繳費明細檔&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>
				...
				<tr>
					...
					<td>
						<html:radio property="feeType" value="2"/>減免學雜費
						<html:radio property="feeType" value="3"/>就學貸款
						<html:radio property="feeType" value="4"/>弱勢助學
					</td>
				</tr>
			</table>
		</td>
