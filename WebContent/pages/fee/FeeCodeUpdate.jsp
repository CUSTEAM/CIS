...
history.go(1);
function check() {
	var iCount = document.getElementById("feeName").value;
	if (iCount == '') {
		alert("收費名稱不可為空白,謝謝!!");
...
<html:form action="/FEE/FeeCode" method="post" onsubmit="init('執行中, 請稍後')">
	...
	<html:hidden property="feeOid" value="${feeCode4U.oid}"/>
	<tr>
		<td>
				...
				<tr bgcolor="#f0fcd7">
					<td class="hairlineTdF">&nbsp;&nbsp;代碼&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF">
                     	<html:text property="feeNo" styleId="feeNo" size="1" readonly="true" disabled="true" maxlength="3" value="${feeCode4U.no}"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                    <td class="hairlineTdF">&nbsp;&nbsp;收費名稱&nbsp;&nbsp;&nbsp;&nbsp;</td>
              		<td class="hairlineTdF">
                     	<html:text property="feeName" styleId="feeName" size="30" maxlength="20" value="${feeCode4U.name}"/>&nbsp;&nbsp;&nbsp;&nbsp;
                     </td>
				</tr>
			</table>
    	</td>
