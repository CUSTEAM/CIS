...
// -->
  ...
  <SELECT name="campusInChargeSAF" onchange="fillSchools();">
    ...
    </c:if></SELECT><SELECT name="schoolInChargeSAF" onchange="fillDepts();">
    </SELECT><SELECT name="deptInChargeSAF" onchange="fillClasses();">
    </SELECT><SELECT name="classInChargeSAF"></SELECT>	   		    
