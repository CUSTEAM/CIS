...
// -->
  ...
  <SELECT name="campusInCharge2" id="campusInCharge2" onchange="fillSchools(), getLess1('campusInCharge2')">
    ...
    </SELECT><SELECT name="classInCharge2" onchange="getLess4('classInCharge2')"></SELECT>
    <input type="text" size="4" name="classLess" id="classLess" value="${OpenCourseBatchForm.map.classLess}"/>
