...
// -->
  ...
  <SELECT name="campusInCharge2" id="campusInCharge2" onchange="fillSchools(), getLess1('campusInCharge2')">
    ...
    </c:if></SELECT><SELECT name="schoolInCharge2" id="schoolInCharge2" onchange="fillDepts(), getLess2('schoolInCharge2'), document.getElementById('examDate').style.display='inline'">
    </SELECT><SELECT disabled name="deptInCharge2" id="deptInCharge2" onchange="fillClasses(), getLess3('deptInCharge2')">
    </SELECT><SELECT disabled name="classInCharge2" onchange="getLess4('classInCharge2')"></SELECT>
    <input type="text" size="4" name="classLess" id="classLess" value="${classLess}" readonly/>	   		    
