...
if(window.location.hostname.indexOf("192")>-1){//如果是我的機器
	FCKConfig.GoogleMaps_Key=FCKConfig.GoogleMaps_Keys[0];
}else{//若不是我的機器
	if(window.location.hostname.indexOf("alliance")>-1){//策盟機
		FCKConfig.GoogleMaps_Key=FCKConfig.GoogleMaps_Keys[3];
	}
	if(window.location.hostname.indexOf("cap")>-1){//cap
		FCKConfig.GoogleMaps_Key=FCKConfig.GoogleMaps_Keys[1];
	}else{//ap
		FCKConfig.GoogleMaps_Key=FCKConfig.GoogleMaps_Keys[2];
	}
}
