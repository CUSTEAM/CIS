...
// -->
  ...
  <select style="font-size:18px;" name="campusInCharge2" id="campusInCharge2" onchange="fillSchools(), getLess1('campusInCharge2')">
    ...
    <select style="font-size:18px;" name="schoolInCharge2" id="schoolInCharge2" onchange="fillDepts(), getLess2('schoolInCharge2')"></select>    
    <select style="font-size:18px;" name="deptInCharge2" id="deptInCharge2" onchange="fillClasses(), getLess3('deptInCharge2')"></select>    
    <select style="font-size:18px;" name="classInCharge2" id="classInCharge2" onchange="getLess4('classInCharge2')"></select>
