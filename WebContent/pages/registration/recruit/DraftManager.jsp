...
<html:form action="Regstration/Recruit/Config/DraftManager" method="post" enctype="multipart/form-data" onsubmit="init('系統處理中...')">
<!-- 標題start -->
	<tr height="30">
		<td class="fullColorTable">		
		<div style="float:left; padding:0 5 0 5;"><img src="images/icon/user_add.gif"/></div>
		<div nowrap style="float:left;"><font class="gray_15">各校錄取率管理</font></div>		
		</td>
	</tr>
	<tr>
		<td>
		<%@ include file="DraftManager/search.jsp"%>
		
		</td>
	</tr>
	<tr>
		<td id="help" style="display:none;">		
		<%@ include file="DraftManager/help.jsp"%>
		</td>
	</tr>
...
<c:if test="${!empty alls}">
	<tr>
		...
		<%@ include file="DraftManager/list.jsp"%>
