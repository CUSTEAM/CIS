...
<html:form action="/Registration/UploadNewStmd" method="post" enctype="multipart/form-data" onsubmit="init('報表產生中, 請稍後')">
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<script>
	generateTableBanner('<table align="left"><tr><td align="left">&nbsp;&nbsp;<img src="images/16-cube-debug.png"></td><td> 上 傳 新 生 基 本 資 料 (未 編 班 編 學 號)</td></tr></table>');
</script>
	<tr>
		<td>
	...
	<tr>
		<td>
			...
			<display:table name="${newStmdList}" export="false" id="row" pagesize="30" sort="list" excludedParams="*" class="list">
