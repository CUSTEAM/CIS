  ...
  <html:form action="/Registration/StudentInfo" method="post">
	<script>generateTableBanner('<div class="gray_15"><B><bean:message key="header.DeleteStudentInfo" bundle="REG"/></B></div>');</script>	  
	  ...
	  <tr><td><table width="100%" cellpadding="0" cellspacing="0">
		 <tr><td align="center">
	      <display:table name="${StudentInfoDelete}" export="false" id="row" pagesize="10000" sort="list" excludedParams="*" class="list">
	        <%@ include file="../include/NoBanner.jsp" %>
	        <display:column title="<script>generateTriggerAll(${fn:length(StudentInfoDelete)}, 'StudentDelete');</script>" class="center" >
	          <script>generateCheckbox("${row.oid}", "StudentDelete");</script></display:column>
