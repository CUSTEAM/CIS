...
<table class="hairLineTable" width="99%">
	<tr>
		...
		查看${aStudent.ClassName}, ${aStudent.student_name} 本學期選課清單, 或 <a href=javascript:history.back()><b>回到學生列表</b></a>
		</td>
	</tr>
</table>
<table class="hairLineTable" width="99%">
	<tr>
		...
		<td class="hairLineTdF">時數</td>
	</tr>
	<c:forEach items="${mySelected}" var="m">
	<tr>
		...
		<td class="hairLineTdF" width="20">${m.thour}</td>
	</tr>
	</c:forEach>
</table>