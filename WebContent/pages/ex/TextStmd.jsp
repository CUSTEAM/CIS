...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <html:form action="/Example/TextStmd" method="post" enctype="multipart/form-data" onsubmit="init('系統處理中...')">
<!-- 標題列 Start -->
    <tr>
      <td class="fullColorTable" width="100%">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr height="30">
            <td align="center" valign="middle"><b>TextStmd&nbsp;</b></td>
          </tr>
        </table>
      </td>
    </tr>
	  ...
	  <td>
		<table class="hairLineTable" width="99%" id="table1">
			<tr>
				...
				<td class="hairLineTdF"><input type="text" name="stmd_no" id="stmd_no" value=""/></td>
			</tr>
			<tr>
				<td class="hairLineTdF" width="100">姓名</td>
				<td class="hairLineTdF"><input type="text" name="stmd_name" id="stmd_name" value=""/></td>
			</tr>
		</table>
	  </td>
	</tr>
	  ...
	  <td>
		<table class="hairLineTable" width="99%" id="table1">
			<tr>
				...
				<td class="hairLineTdF"><input type="text" name="class_no" id="class_no" value=""/></td>
			</tr>
			<tr>
				<td class="hairLineTdF" width="100">班級名稱</td>
				<td class="hairLineTdF"><input type="text" name="class_name" id="class_name" value=""/></td>
			</tr>
		</table>
		</td>
	</tr>
...
<!-- 動作按鍵列 Start -->
    <tr>
      <td class="hairLineTd" align="center">
        ...
        <input type="button" class="gCancle" value="返回" id="Back" onclick="location='/CIS/Example/Directory.do';"/>        
<!-- 
        <input type="submit" class="gCancle" name="method" value="<bean:message key='Create'/>" class="CourseButton"/> 新增
        <input type="submit" class="gCancle" name="method" value="<bean:message key='Modify'/>" onClick="return myTest()" class="CourseButton"/> 修改
        <input type="submit" class="gCancle" name="method" value="<bean:message key='Delete'/>" onClick="return myTest()" class="CourseButton"/> 刪除
        <input type="submit" name="method" value="<bean:message key='GoOn'/>" onClick="return myTest0()" class="gSubmit"/> 下一步        
-->        
      </td>
    </tr>
<!-- 動作按鍵列 End -->    
