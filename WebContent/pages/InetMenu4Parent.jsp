...
<table width="100%" cellpadding="0" cellspacing="0">
	<TR><TD vAlign="bottom" align="left">
 	    <font class="gray_15"><B>
    		&nbsp;&nbsp;&nbsp;歡迎! ${Credential.member.name}同學的家長</B></font></TD></TR>
</table>
<FORM>
       ...
       <c:if test="${not empty menuItem.subMenu}" >
        <c:if test="${menuItem.collapse}" >
         ...
         <TR><TD>
   	    ...
   	    <TR height="35">
  	  <TD class="table-boder" width="100%" valign="center">
          &nbsp;<html:link page="/InetLogout4Parent.do" onclick="CloseWindow('tools');"><font class="gray_15"><B><bean:message key="Logout"/></B></font></html:link></TD>
      </TR>
	</TABLE>
</FORM>        
  <script>
