  	...
  	<tr>
    	<td width="160" valign="top" bgcolor="#CCCCCC"><p>&nbsp;</p>
      		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        		...
        		<tr>
          			<td><a class="sidelink" href="http://ap.cust.edu.tw/CIS4P">家長專區</a></td>
        		</tr>
        		<tr>
    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="0">
      			<tr>
        			<td valign="top" id="maincontent"><div>
        				<html:form action="/OpenCourseSearch" method="post">
        				開課班級：
							...
							<tr>
								<td>
									<display:table name="${literacyClassList}" export="false" id="row" pagesize="10000" sort="list" excludedParams="*" class="list">
			        					...
			        					<display:column titleKey="Course.label.classNo" property="ClassNo" sortable="false" />
			        					<display:column titleKey="Course.label.className" property="ClassName" sortable="false" />
			        					<display:column titleKey="Course.label.courseNumber" property="Oid" sortable="false"  />  
			        					<display:column titleKey="Course.label.courseName" property="chi_name" sortable="false" />
			        					<display:column titleKey="Course.label.techName" property="cname" sortable="false"  />
			        					...
			        					<display:column titleKey="Course.label.classTime" property="time" sortable="false" />
			        					<display:column titleKey="Course.label.place" sortable="false">
