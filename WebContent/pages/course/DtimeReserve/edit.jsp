	...
	<tr>		
		...
		<table class="hairLineTable" cellpadding="5" cellspacing="5" width="99%">			
			...
			<tr>
				...
				<input type="text" name="Oid" value="${aDtimeReserve.Oid }"/>
				...
				name="chi_name" id="chi_name" onMouseDown="clearid(this.id), clearid('cscode')"
				...
				<td class="hairLineTdF">				
				<input type="text" size="4" style="font-size:18px;" value="${aDtimeReserve.cname}" onMouseDown="clearid(this.id), clearid('techid')"
	...
	<tr>
		...
		<table class="hairLineTable" cellpadding="5" cellspacing="5" width="50%">
			...
			<tr>
				...
				<input type="text" size="4" style="font-size:18px;" onMouseDown="clearid(this.id), clearid('techid0')"
			...
			<tr>
				...
				<input type="text" size="4" style="font-size:18px;" value="${t.cname}" onMouseDown="clearid(this.id), clearid('techid${t.Oid}')"
