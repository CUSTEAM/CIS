...
if(request.getParameter("type").equals("word")){
	...
	response.setHeader("Content-Disposition","attachment;filename=list4CheckClass.doc");
}
if(request.getParameter("type").equals("excel")){
	response.setContentType("application/vnd.ms-excel");
	response.setHeader("Content-disposition","attachment;filename=list4CheckClass.xls");
}
...
<table>
<!-- 班級衝堂 -->
<c:if test="${not empty CheckClass}">
	<tr>
		<td>
			<table border="1" align="left" cellpadding="0" cellspacing="1" bgcolor="#CFE69F" width="100%">
				...
				<tr height="20">
					...
					<%int i=0;%>
					<c:forEach items="${CheckClass}" var="dl">
					<%i=i+1;%>
						<tr height="20">
