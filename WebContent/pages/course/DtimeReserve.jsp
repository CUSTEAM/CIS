...
<!-- 標題 start -->
<html:form action="/Course/DtimeReserveManager" method="post" onsubmit="init('處理中, 請稍後')">
	<tr height="30">
...
<c:if test="${aDtimeReserve!=null}">
	<tr>
		<td>
		<%@ include file="DtimeReserve/edit.jsp"%>
		</td>
	</tr>	
</c:if>
...
<c:if test="${aDtimeReserve==null}">
	<tr>
		<td>
		<%@ include file="DtimeReserve/search.jsp"%>			
		</td>
	</tr>	
	<c:if test="${opt1!=null}">
	<tr>
		<td>
		<%@ include file="DtimeReserve/list.jsp"%>		
		</td>
	</tr>
	</c:if>
</c:if>
