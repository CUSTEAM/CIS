...
<!-- 標題 start -->
<html:form action="/AMS/EmplShiftManager" method="post" onsubmit="init('處理中, 請稍後')">
	<tr height="30">
		<td class="fullColorTable">		
		<div style="float:left; padding:0 5 0 5;"><img src="images/icon/user_tick.gif"/></div>
		<div nowrap style="float:left;"><font class="gray_15">個人排班管理</font></div>		
		</td>
	</tr>
	<tr>
		<td>		
		<%@ include file="EmplShiftManager/search.jsp"%>		
		</td>
	</tr>
	<tr>
		<td id="help" style="display:none;">
		<%@ include file="EmplShiftManager/help.jsp"%>		
		</td>
	</tr>	
	<tr height="30">
...
<c:if test="${!empty myShift}">
	<tr>
		<td>		
		<%@ include file="EmplShiftManager/list.jsp"%>		
		</td>
	</tr>
	<tr height="30">
		<td class="fullColorTable" align="center">
