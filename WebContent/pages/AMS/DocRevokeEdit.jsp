...
<input name="opmode" type="hidden" value="revoke"/>
<input name="docType" type="hidden" value="${DocRevokeEditInit.docType}"/>
...
<input name="oid" type="hidden" value="${Doc4Revoke.oid}"/>
<table width="100%" cellpadding="2" cellspacing="2">
<script>generateTableBanner('銷假管理->新增');</script>	  
<!-- End Content Page Table Header -->
	...
	<c:set var="askleave" value="${Doc4Revoke}"></c:set>
	<tr>
		<td  class="title" colspan="2" style="background-color:#9999ee;">欲銷假假單內容</td>
	</tr>
	<tr>
	...
	<c:choose>
	<c:when test="${DocRevokeEditForm != null}">
	<c:set var="formback" value="${DocRevokeEditForm}"></c:set>
	<tr>
		<td width="75" height="50" class="title">銷假原因</td>
