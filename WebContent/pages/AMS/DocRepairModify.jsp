...
<input name="docType" type="hidden" value="${DocRepairModifyInit.docType}"/>
...
<script>generateTableBanner('未刷卡補登管理->修改');</script>	  
<!-- End Content Page Table Header -->
	<tr><td><table>
	<c:choose>
	<c:when test="${DocRepairModifyForm != null}">
	<c:set var="formback" value="${DocRepairModifyForm}"></c:set>
	...
	<c:when test="${DocRepairInEdit != null}">
	<c:set var="formback" value="${DocRepairInEdit}"></c:set>
	<input name="oid" type="hidden" value="${formback.oid}"/>
	<tr>
		<td width="75" class="title">未刷卡原因</td>
		<td class="input"><input type="text" name="reason" class="mustInput" value="${formback.reason}"></td>
	...
	<tr>
		...
		<select name="startMinute" id="startMinute">
			<c:if test="${formback.startMinute == null}">
			<option value="0" selected="selected">0</option>
			<option value="30">30</option>
			</c:if>
			<c:if test="${0 == formback.startMinute}">
	...
	<tr>
		...
		<select name="endMinute" id="endMinute">
			<c:if test="${formback.endMinute == null}">
			<option value="0" selected="selected">0</option>
			<option value="30">30</option>
			</c:if>
			<c:if test="${0 == formback.endMinute}">
