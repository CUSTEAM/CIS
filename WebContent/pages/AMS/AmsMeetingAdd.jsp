...
<!-- 標題列 Start -->
	<tr>
		<td class="fullColorTable" width="100%">
	    	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	      		<tr height="30">
	        		<script>generateTableBanner('<div class="gray_15"><B>重 要 集 會 新 增</B></div>');</script>
	      		</tr>
	    	</table>
	  	</td>
	</tr>
        	...
        	<table width="100%" cellpadding="0" cellspacing="0">
          		...
          		<tr>
            		<td class="hairLineTd" align="center">
              			<input type="submit" name="method" value="<bean:message key='Save'/>" onClick="return check()" class="CourseButton"/>
