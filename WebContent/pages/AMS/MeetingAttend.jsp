...
<!-- 標題 start -->
<html:form action="/AMS/MeetingAttend" method="post" onsubmit="init('處理中, 請稍後')">
	<tr height="30">
		<td class="fullColorTable">		
		<div style="float:left; padding:0 5 0 5;"><img src="images/icon/user_tick.gif"/></div>
		<div nowrap style="float:left;"><font class="gray_15">集會出席狀況維護</font></div>		
		</td>
	</tr>
	<tr>
		<td>		
		<%@ include file="include/MeetingAttend/search.jsp"%>		
		</td>
	</tr>
	<tr>
		<td id="help" style="display:none;">
		<%@ include file="include/MeetingAttend/help.jsp"%>		
		</td>
	</tr>	
	<tr height="30">
		...
		<input type="submit" name="method" 
					...
					onMouseOver="showHelpMessage('查詢與會名單', 'inline', this.id)" 
...
<c:if test="${!empty myMeeting}">
	<tr>
		<td>		
		<%@ include file="include/MeetingAttend/list.jsp"%>		
		</td>
	</tr>
	<tr height="30">
		<td class="fullColorTable" align="center">
