...
<input name="docType" type="hidden" value="${DocOverTimeDelInit.docType}"/>
...
<script>generateTableBanner('加班管理->請確認刪除!');</script>	  
<!-- End Content Page Table Header -->
	<tr><td><table>
	<c:forEach items="${DocOverTimeDelete}" var="formback">
	<tr>
