...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <html:form action="/DeptAssistant/AbilityExamine" method="post" onsubmit="init('執行中, 請稍後')">
  
  <!-- 主查詢界面 start-->
  
  <!-- 快速查詢 start -->
  <tr>
    <td><input type="hidden" name="exSearch" value="${AbilityExamineForm.map.exSearch}"/><br>
          ...
          <td>	
            <table width="100%">
              <tr>
                <td>
                  <table width="100%">														
                    <tr <c:if test="${AbilityExamineForm.map.exSearch!=''}">style="display:none"</c:if> id="onlyEdit">
                      <td>
                            ...
                            <td>               
                              ...
                              <input type="text" 
                                     style="ime-mode:disabled" 
                              	     ...
                              	     id="studentNo" 
                              	     size="12" 
                              	     value="${AbilityExamineForm.map.studentNoC}"
                              ...
                              <input type="text" 
                                     ...
                                     id="studentName" 
                                     size="10" 
                                     value="${AbilityExamineForm.map.nameC}"
  ...
  <tr>
    <td>				
      <table width="100%">
        <tr <c:if test="${AbilityExamineForm.map.exSearch==''}">style="display:none"</c:if> id="searchBar">
          <td>
            <table>					
              <tr>
                <td>							
                      ...
                      <td>
                        <table bgcolor="cfe69f" cellpadding="5" cellspacing="1" bgcolor="#CFE69F">
                          <tr bgcolor="#f0fcd7">
                            <td>班別</td>
                            <td colspan="3">
                              <c:set var="campusSel" value="${AbilityExamineForm.map.campusInChargeC}"/>
                              <c:set var="schoolSel" value="${AbilityExamineForm.map.schoolInChargeC}"/>
                              <c:set var="deptSel"   value="${AbilityExamineForm.map.deptInChargeC}"/>
                              <c:set var="classSel"  value="${AbilityExamineForm.map.classInChargeC}"/>
...
<script>  
  ...
  function showAddBarOne() //開啟單一新增區塊
  {
    var iCount;
    iCount = getCookie("resultDataCount");
    if (iCount == 0) 
