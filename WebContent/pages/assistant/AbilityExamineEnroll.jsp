...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <html:form action="/DeptAssistant/AbilityExamineEnroll" method="post" onsubmit="init('執行中, 請稍後')">
  
  <!-- 主查詢界面 start-->
  
  <!-- 快速查詢 start -->
  <tr>
    <td><input type="hidden" name="exSearch" value="${AbilityExamineEnrollForm.map.exSearch}"/><br>
          ...
          <td>	
            <table width="100%">
              <tr>
                <td>
                  <table width="100%">														
                    <tr <c:if test="${AbilityExamineEnrollForm.map.exSearch!=''}">style="display:none"</c:if> id="onlyEdit">
                      <td>
                          ...
                          <tr bgcolor="#f0fcd7">
                            ...
                            <td>
                              <input type="text" style="ime-mode:disabled" 
                              	name="studentNoC" id="studentNo" size="12" value="${AbilityExamineEnrollForm.map.studentNoC}"
                              	onkeyup="if(this.value.length>=6)GgetAny(this.value, 'studentNo', 'studentName', 'gstmd', 'no')" onClick="clearQuery()" />
                              
                              <input type="text" name="nameC" id="studentName" size="10" value="${AbilityExamineEnrollForm.map.nameC}"
  ...
  <tr>
    <td>				
      <table width="100%">
        <tr <c:if test="${AbilityExamineEnrollForm.map.exSearch==''}">style="display:none"</c:if> id="searchBar">
          <td>
            <table>					
              <tr>
                <td>							
