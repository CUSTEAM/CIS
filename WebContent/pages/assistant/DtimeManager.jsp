...
<!-- 標題 start -->
<html:form action="/DepAssistant/DtimeManager" method="post" onsubmit="init('處理中, 請稍後...')">
	<tr height="30">
...
<c:if test="${aDtimeReserve!=null}">
	<tr>
		<td>
		<%@ include file="DtimeManage/edit.jsp"%>
		</td>
	</tr>	
</c:if>
...
<c:if test="${aDtimeReserve==null}">
	<tr>
		<td>
		<%@ include file="DtimeManage/search.jsp"%>			
		</td>
	</tr>	
	<c:if test="${opt1!=null}">
	<tr>
		<td>
		<%@ include file="DtimeManage/list.jsp"%>		
		</td>
	</tr>
	</c:if>
</c:if>
