...
<html:form action="/DepAssistant/Timetabling" method="post" onsubmit="init('處理中, 請稍後')">
	<tr height="30">
		<td class="fullColorTable">		
		<div style="float:left; padding:0 5 0 5;"><img src="images/icon/application_view_icons.gif"/></div>
		<div nowrap style="float:left;"><font class="gray_15">排課管理</font></div>		
		</td>
	</tr>	
	<tr>
		<td>
		<%@ include file="Timetabling/search.jsp"%>		
		</td>
	</tr>
	...
	<tr>
		<td>
		<%@ include file="Timetabling/edit.jsp"%>	
		</td>
	</tr>
	<tr height="30">
		<td class="fullColorTable">
