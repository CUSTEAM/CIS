...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
  <html:form action="/${ClassInChargeSetup.baseDir}/ClassInChargeSetup4${ClassInChargeSetup.authority}" method="post">
   ...
   <c:if test="${ClassInChargeSetup.found == true}">
		...
		<tr><td>&nbsp;
		  班級代碼&nbsp;
		 <input type="text" name="classNo" size="8" >&nbsp;( 例:164* )
		 <input type="submit" name="method" value="<bean:message key='BatchInsert'/>" onclick="return checkClassNoInput();" ></td></tr>
		<tr><td width="100%">
	...
	<script>generateTableBanner('<INPUT type="submit" name="method" class="CourseButton" value="<bean:message key='OK'/>" >&nbsp;&nbsp;'
	  ...
	  <!--
	  	  function checkClassNoInput() {
	  	  	var value = document.forms[0].classNo.value;
   			if (value=='' || value=='*') {
   				alert("<bean:message key='Message.ClassNoMustInput'/>");
   				return false;
   			} else {
   				return true;
   			}
